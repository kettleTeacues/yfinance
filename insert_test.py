...
if __name__ == "__main__":
    ...
    earnings_count = insert_stock_earnings_dates(symbol)
    ...
    estimate_count = insert_stock_earnings_estimate(symbol)
    ...
    history_count = insert_stock_earnings_history(symbol)
    ...
    revisions_count = insert_stock_eps_revisions(symbol)
    ...
    growth_count = insert_stock_growth_estimates(symbol)
    ...
    income_stmt_count = insert_stock_income_stmt(symbol)
    ...
    insider_purchases_count = insert_stock_insider_purchases(symbol)
    ...
    institutional_holders_count = insert_stock_institutional_holders(symbol)
    ...
    major_holders_count = insert_stock_major_holders(symbol)
    ...
    mutualfund_holders_count = insert_stock_mutualfund_holders(symbol)
    ...
    revenue_estimate_count = insert_stock_revenue_estimate(symbol)
    ...
    sustainability_count = insert_stock_sustainability(symbol)
